...
const CardFeeReportForm = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: CardFeeReportFormValidationSchema,
    onSubmit: async (values) => {
      ...
      try {
        ...
        values.returnCardNumber = 0;
        values.reason = "";
        console.log("values", values);
        const res = await createReport(user, values, "CardFee");
              ...
              {isCountdownActive ? (
                ...
                >
                  <Grid container spacing={2}>
                    ...
                    <CustomTextField
                      name="price" // Use lowercase field name
                      label="Price" // Use lowercase field name
...
export default CardFeeReportForm;
